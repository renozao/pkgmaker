...
\title{\texttt{pkgmaker}: Unit testing results\footnote{Vignette computed  on Sat Nov  3 00:19:02 2012}}
\date{\texttt{pkgmaker} version 0.8.19 as of November  3, 2012}
\usepackage{Sweave}
\begin{document}
\maketitle

\begin{verbatim}
RUNIT TEST PROTOCOL -- Sat Nov  3 00:19:02 2012 
*********************************************** 
...
\begin{itemize}\raggedright
  ...
  \item Base packages: base, datasets, graphics, grDevices, methods,
    stats, utils
  \item Other packages: codetools~0.2-8, digest~0.5.2, pkgmaker~0.8.19,
