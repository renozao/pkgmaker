...
\title{\texttt{pkgmaker}: Unit testing results\footnote{Vignette computed  on Thu Nov 22 13:29:00 2012}}
\date{\texttt{pkgmaker} version 0.9.4 as of November 22, 2012}
\usepackage{Sweave}
\begin{document}
\maketitle
...
RUNIT TEST PROTOCOL -- Thu Nov 22 13:29:00 2012 
*********************************************** 
...
Involved directory: 
/tmp/tmp.45j4gHjyHE/pkgmaker/tests 
--------------------------- 
Test file: /tmp/tmp.45j4gHjyHE/pkgmaker/tests/runit.options.r 
test.option_link: (12 checks) ... OK (0.01 seconds)
test.resetOptions: (9 checks) ... OK (0.01 seconds)
--------------------------- 
Test file: /tmp/tmp.45j4gHjyHE/pkgmaker/tests/runit.utils.r 
...
\begin{itemize}\raggedright
  ...
  \item Base packages: base, datasets, graphics, grDevices, methods,
    stats, utils
  \item Other packages: codetools~0.2-8, digest~0.5.2, pkgmaker~0.9.4,
