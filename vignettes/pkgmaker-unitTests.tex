...
\title{\texttt{pkgmaker}: Unit testing results\footnote{Vignette computed  on Tue Mar 19 16:27:22 2013}}
\date{\texttt{pkgmaker} version 0.15.1 as of March 19, 2013}
\usepackage{Sweave}
\begin{document}
\maketitle
...
RUNIT TEST PROTOCOL -- Tue Mar 19 16:27:22 2013 
*********************************************** 
...
Involved directory: 
/tmp/Rpkglib_622066d28e29/pkgmaker/tests 
--------------------------- 
Test file: /tmp/Rpkglib_622066d28e29/pkgmaker/tests/runit.options.r 
test.option_link: (12 checks) ... OK (0.01 seconds)
test.resetOptions: (9 checks) ... OK (0.01 seconds)
--------------------------- 
Test file: /tmp/Rpkglib_622066d28e29/pkgmaker/tests/runit.utils.r 
...
\begin{itemize}\raggedright
  ...
  \item Base packages: base, datasets, graphics, grDevices, methods,
    stats, utils
  \item Other packages: pkgmaker~0.15.1, registry~0.2, RUnit~0.4.26,
    stringr~0.6.2
