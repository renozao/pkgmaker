...
\title{\texttt{pkgmaker}: Unit testing results\footnote{Vignette computed  on Wed Feb 27 16:31:37 2013}}
\date{\texttt{pkgmaker} version 0.12 as of February 27, 2013}
\usepackage{Sweave}
\begin{document}
\maketitle
...
RUNIT TEST PROTOCOL -- Wed Feb 27 16:31:37 2013 
*********************************************** 
...
Involved directory: 
/tmp/Rpkglib_53177ae2f36/pkgmaker/tests 
--------------------------- 
Test file: /tmp/Rpkglib_53177ae2f36/pkgmaker/tests/runit.options.r 
test.option_link: (12 checks) ... OK (0.01 seconds)
test.resetOptions: (9 checks) ... OK (0.01 seconds)
--------------------------- 
Test file: /tmp/Rpkglib_53177ae2f36/pkgmaker/tests/runit.utils.r 
...
\begin{itemize}\raggedright
  ...
  \item Base packages: base, datasets, graphics, grDevices, methods,
    stats, utils
  \item Other packages: pkgmaker~0.12, registry~0.2, RUnit~0.4.26,
    stringr~0.6.2
