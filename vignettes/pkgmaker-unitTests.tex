...
\title{\texttt{pkgmaker}: Unit testing results\footnote{Vignette computed  on Thu Mar  7 08:50:25 2013}}
\date{\texttt{pkgmaker} version 0.13.1 as of March  7, 2013}
\usepackage{Sweave}
\begin{document}
\maketitle
...
RUNIT TEST PROTOCOL -- Thu Mar  7 08:50:25 2013 
*********************************************** 
...
Involved directory: 
/tmp/Rpkglib_f7414bb8e1f/pkgmaker/tests 
--------------------------- 
Test file: /tmp/Rpkglib_f7414bb8e1f/pkgmaker/tests/runit.options.r 
test.option_link: (12 checks) ... OK (0.01 seconds)
test.resetOptions: (9 checks) ... OK (0.01 seconds)
--------------------------- 
Test file: /tmp/Rpkglib_f7414bb8e1f/pkgmaker/tests/runit.utils.r 
...
\begin{itemize}\raggedright
  ...
  \item Base packages: base, datasets, graphics, grDevices, methods,
    stats, utils
  \item Other packages: pkgmaker~0.13.1, registry~0.2, RUnit~0.4.26,
    stringr~0.6.2
