...
\title{\texttt{pkgmaker}: Unit testing results\footnote{Vignette computed  on Wed Nov 14 15:17:56 2012}}
\date{\texttt{pkgmaker} version 0.9.3 as of November 14, 2012}
\usepackage{Sweave}
\begin{document}
\maketitle
...
RUNIT TEST PROTOCOL -- Wed Nov 14 15:17:56 2012 
*********************************************** 
...
Involved directory: 
/tmp/tmp.0cRG3rgzpX/pkgmaker/tests 
--------------------------- 
Test file: /tmp/tmp.0cRG3rgzpX/pkgmaker/tests/runit.options.r 
test.option_link: (12 checks) ... OK (0.01 seconds)
test.resetOptions: (9 checks) ... OK (0.01 seconds)
--------------------------- 
Test file: /tmp/tmp.0cRG3rgzpX/pkgmaker/tests/runit.utils.r 
...
\begin{itemize}\raggedright
  ...
  \item Base packages: base, datasets, graphics, grDevices, methods,
    stats, utils
  \item Other packages: codetools~0.2-8, digest~0.5.2, pkgmaker~0.9.3,
