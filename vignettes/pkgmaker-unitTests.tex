...
\title{\texttt{pkgmaker}: Unit testing results\footnote{Vignette computed  on Thu Mar  7 15:23:58 2013}}
\date{\texttt{pkgmaker} version 0.13.2 as of March  7, 2013}
\usepackage{Sweave}
\begin{document}
\maketitle
...
RUNIT TEST PROTOCOL -- Thu Mar  7 15:23:58 2013 
*********************************************** 
...
Involved directory: 
/tmp/Rpkglib_1deb12b5df8d/pkgmaker/tests 
--------------------------- 
Test file: /tmp/Rpkglib_1deb12b5df8d/pkgmaker/tests/runit.options.r 
test.option_link: (12 checks) ... OK (0.01 seconds)
test.resetOptions: (9 checks) ... OK (0.01 seconds)
--------------------------- 
Test file: /tmp/Rpkglib_1deb12b5df8d/pkgmaker/tests/runit.utils.r 
...
\begin{itemize}\raggedright
  ...
  \item Base packages: base, datasets, graphics, grDevices, methods,
    stats, utils
  \item Other packages: pkgmaker~0.13.2, registry~0.2, RUnit~0.4.26,
    stringr~0.6.2
