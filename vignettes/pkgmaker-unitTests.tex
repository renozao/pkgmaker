...
\title{\texttt{pkgmaker}: Unit testing results\footnote{Vignette computed  on Tue Mar 12 10:09:01 2013}}
\date{\texttt{pkgmaker} version 0.14 as of March 12, 2013}
\usepackage{Sweave}
\begin{document}
\maketitle
...
RUNIT TEST PROTOCOL -- Tue Mar 12 10:09:00 2013 
*********************************************** 
...
Involved directory: 
/tmp/Rpkglib_55ca759c092d/pkgmaker/tests 
--------------------------- 
Test file: /tmp/Rpkglib_55ca759c092d/pkgmaker/tests/runit.options.r 
test.option_link: (12 checks) ... OK (0.01 seconds)
test.resetOptions: (9 checks) ... OK (0.01 seconds)
--------------------------- 
Test file: /tmp/Rpkglib_55ca759c092d/pkgmaker/tests/runit.utils.r 
