...
\title{\texttt{pkgmaker}: Unit testing results\footnote{Vignette computed  on Mon Mar 11 11:08:12 2013}}
\date{\texttt{pkgmaker} version 0.14 as of March 11, 2013}
\usepackage{Sweave}
\begin{document}
\maketitle
...
RUNIT TEST PROTOCOL -- Mon Mar 11 11:08:12 2013 
*********************************************** 
...
Involved directory: 
/tmp/Rpkglib_1dd23403ddc3/pkgmaker/tests 
--------------------------- 
Test file: /tmp/Rpkglib_1dd23403ddc3/pkgmaker/tests/runit.options.r 
test.option_link: (12 checks) ... OK (0.01 seconds)
test.resetOptions: (9 checks) ... OK (0.01 seconds)
--------------------------- 
Test file: /tmp/Rpkglib_1dd23403ddc3/pkgmaker/tests/runit.utils.r 
...
\begin{itemize}\raggedright
  ...
  \item Base packages: base, datasets, graphics, grDevices, methods,
    stats, utils
  \item Other packages: pkgmaker~0.14, registry~0.2, RUnit~0.4.26,
    stringr~0.6.2
