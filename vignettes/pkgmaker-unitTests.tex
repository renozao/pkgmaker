...
\title{\texttt{pkgmaker}: Unit testing results\footnote{Vignette computed  on Wed Mar  5 12:27:03 2014}}
\date{\texttt{pkgmaker} version 0.20 as of March  5, 2014}
...
RUNIT TEST PROTOCOL -- Wed Mar  5 12:27:03 2014 
*********************************************** 
...
Involved directory: 
/tmp/Rpkglib_6bdd61d9aee8/pkgmaker/tests 
--------------------------- 
Test file: /tmp/Rpkglib_6bdd61d9aee8/pkgmaker/tests/runit.options.r 
test.option_link: (12 checks) ... OK (0.01 seconds)
test.resetOptions: (9 checks) ... OK (0 seconds)
--------------------------- 
Test file: /tmp/Rpkglib_6bdd61d9aee8/pkgmaker/tests/runit.utils.r 
...
\begin{itemize}\raggedright
  ...
  \item Base packages: base, datasets, graphics, grDevices, methods,
    stats, utils
  \item Other packages: pkgmaker~0.20, registry~0.2, RUnit~0.4.26,
    stringr~0.6.2
