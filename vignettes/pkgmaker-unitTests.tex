...
\title{\texttt{pkgmaker}: Unit testing results\footnote{Vignette computed  on Thu Sep 19 11:23:34 2013}}
\date{\texttt{pkgmaker} version 0.17.3 as of September 19, 2013}
...
RUNIT TEST PROTOCOL -- Thu Sep 19 11:23:34 2013 
*********************************************** 
...
Involved directory: 
/tmp/Rpkglib_775e5a9085d/pkgmaker/tests 
--------------------------- 
Test file: /tmp/Rpkglib_775e5a9085d/pkgmaker/tests/runit.options.r 
test.option_link: (12 checks) ... OK (0.01 seconds)
test.resetOptions: (9 checks) ... OK (0.01 seconds)
--------------------------- 
Test file: /tmp/Rpkglib_775e5a9085d/pkgmaker/tests/runit.utils.r 
...
\begin{itemize}\raggedright
  ...
  \item Base packages: base, datasets, graphics, grDevices, methods,
    stats, utils
  \item Other packages: pkgmaker~0.17.3, registry~0.2, RUnit~0.4.26,
    stringr~0.6.2
