...
\title{\texttt{pkgmaker}: Unit testing results\footnote{Vignette computed  on Thu Nov 29 12:17:58 2012}}
\date{\texttt{pkgmaker} version 0.9.6 as of November 29, 2012}
\usepackage{Sweave}
\begin{document}
\maketitle
...
RUNIT TEST PROTOCOL -- Thu Nov 29 12:17:57 2012 
*********************************************** 
...
Involved directory: 
/tmp/tmp.xAC4DYU9QI/pkgmaker/tests 
--------------------------- 
Test file: /tmp/tmp.xAC4DYU9QI/pkgmaker/tests/runit.options.r 
test.option_link: (12 checks) ... OK (0.01 seconds)
test.resetOptions: (9 checks) ... OK (0.01 seconds)
--------------------------- 
Test file: /tmp/tmp.xAC4DYU9QI/pkgmaker/tests/runit.utils.r 
...
\begin{itemize}\raggedright
  ...
  \item Base packages: base, datasets, graphics, grDevices, methods,
    stats, utils
  \item Other packages: pkgmaker~0.9.6, RUnit~0.4.26, stringr~0.6.1
